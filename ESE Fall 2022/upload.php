...
if (!isset($_POST['submit']))
{
	...
	echo '<div class="col-md-2"><span class="btn btn-file btn-primary">';
...
if (isset($_POST['submit']))
{
	...
	//fwrite($fp,$content);
	//fclose($fp);
	//header("Location: https://ec2-18-191-226-157.us-east-2.compute.amazonaws.com/hw3/upload.php?msg=success");
